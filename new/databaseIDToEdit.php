		...
		<div class="container">
			<div class="text-center">
				<div class="col-sm-8 col-sm-offset-2" style="margin-top:75px;">
					<h2 class="title-one animated bounceInLeft">Edit products in database</h2>
				</div>
			</div>
		</div>
	</section>
        ...
        <div class="container">
            <div class="row col-sm-8 col-sm-offset-2 text-center">
                <div class="col-lg-8 col-lg-offset-2">
                    <h1>Query form</h1>
                    <p class="lead">Enter product ID to be edited</p>
						<form id="queryRemove-form" method="post" action="databaseEditTemplate.php" role="form" enctype="multipart/form-data">
						    ...
						    <div class="controls">
					            ...
					            <div class="col-md-12">
						                <input type="submit" class="btn btn-success btn-send" value="Find Product">
						            </div>
						        <div class="row">
